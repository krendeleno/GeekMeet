    ...
    return (
        <View style={globalStyles.container}>
            ...
            <Input onChange={onChangeValidate} placeholder="Пароль" name="password" value={userData.password}
                   error={isValid.password} errorMessage={errorMessages.password} color={colors.green} size={contentWidth.small} height={50}/>
            <Input onChange={onChangeValidate} placeholder="Повторите пароль" name="confirmPassword"
                   value={userData.confirmPassword} color={colors.green} size={contentWidth.small} height={50} error={'false'}/>
